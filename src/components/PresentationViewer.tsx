...
import { presentationSlidesRu } from "@/data/presentationSlidesRu";
import { presentationSlidesKz } from "@/data/presentationSlidesKz";

export const PresentationViewer = ({ lang }: { lang: "ru" | "kz" }) => {
  const slides = lang === "ru" ? presentationSlidesRu : presentationSlidesKz;
  ...
  return (
    <div className={`relative w-full h-screen bg-[#f8fafc] overflow-hidden flex flex-col font-sans ${isFullscreen ? "fixed inset-0 z-50 fixed-ios" : ""}`}>
      {/* Top Controls Bar */}
